...
/**
 * Builds an animation from a file with animation commands.
 *
 * @param <Doc> The type of thing that is being built (changed to match out model).
 */
public interface AnimationBuilder<Doc> {
   ...
   */
  AnimationBuilder<Doc> addMotion(String name,
      int t1, int x1, int y1, int w1, int h1, int r1, int g1, int b1, int o1,
      int t2, int x2, int y2, int w2, int h2, int r2, int g2, int b2, int o2);
   ...
   */
  AnimationBuilder<Doc> addKeyframe(String name,
      int t, int x, int y, int w, int h, int r, int g, int b, int o);
